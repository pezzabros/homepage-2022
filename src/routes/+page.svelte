...
<section id="intro">
  ...
  <!--<div class="contacts">
    ...
    <a href="#"><div class="icon github"></div></a>
  </div>-->
...
<section id="teaching">
	...
	<ul>
		...
		<li>
			<strong>IronHack - Barcelona</strong> - Talk
			<i>"Show me the data! - From big data to visual information"</i> - Barcelona Data Week. (2019)
		</li>
		<li>
			<strong>IUAV University of Venice</strong> - Teacher of
			<i>"Mobile app design and development with cross-platform tools"</i> - Master in Interactive Media
			for Interior Design. (2016-2017)
		</li>
		<li>
			<strong>University of Florence</strong> - Teacher of <i>"Server side development with PHP"</i>
			and <i>"Rich Internet Applications"</i> - Master in Multimedia Content Design. (2011 - 2014)
		</li>
		<li>
			<strong>University of Florence</strong> - Lecturer of
			<i>"Multimedia Design and Development"</i> - BSc in Computer Science Engineering. (2011 - 2016)
		</li>
	</ul>
</section>
